package com.zrxh.pingche.hession.scanner;
                ...
                for (BeanDefinition candidate : candidates) {
                  ...
                  //  HessianServiceExporter.class.getClassLoader().getResource(name)
                    ...
                    try {
                        ...
                        String targetName = bd.getMetadata().getClassName();
                        Class<?> targetClass = Class.forName(targetName);
                        beanName = targetClass.getAnnotation(HessianService.class).value();
                    ...
                    // candidate);
                    // }
                    beanName = beanName.startsWith("//")?beanName : "/"+beanName;
                    beanName = !beanName.endsWith(".hessian")?beanName+".hessian":beanName;
